...
SWEP.PrintName = "Demonic Wand"
SWEP.WandModel = "models/mstick/demonicstick/w_dstick.mdl"
...
SWEP.VElements = {
	...
	["m"] = { type = "Model", model = SWEP.WandModel, bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5, 1.5, -11), angle = Angle(-165, 0, 0), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, skin = 0, bodygroup = {} }
}
