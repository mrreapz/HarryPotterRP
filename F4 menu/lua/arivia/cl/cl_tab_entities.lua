    ...
    for i = 0, 0 do
        for k, v in ipairs( DarkRPEntities ) do
            ...
            function ListItem:Paint( w, h )
                ...
                if Arivia.TabEntities.xpsystemEnabled and LevelSystemConfiguration then
                ...
                if LevelSystemPrestigeConfiguration and Arivia.TabEntities.prestigeEnabled then
                ...
                if (Arivia.TabEntities.xpsystemEnabled and ( LevelSystemConfiguration ) ) or (Arivia.TabEntities.prestigeEnabled and ( LevelSystemPrestigeConfiguration or v.prestige ) )  then
                    originNameX = 11
                end
                ...
                draw.DrawText( objectName, "AriviaFontObjectListName", 65, originNameX, Arivia.TabEntities.nameColor or Color( 255, 240, 244 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )

                if Arivia.TabEntities.xpsystemEnabled then
                    if LevelSystemConfiguration then
                        ...
                        if Arivia.TabEntities.prestigeEnabled and LevelSystemPrestigeConfiguration then
                            draw.DrawText( prestigeText, "AriviaFontObjectLevel", 140, 35, Color( 255, 240, 244, 100 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )
                        end
                    end
                elseif Arivia.TabEntities.prestigeEnabled then
